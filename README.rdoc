== About this fork - sccdigital

This was forked from http://github.com/jchunky/table_builder

This fork was created so that we could easily generate a 365 day calendar that loops around. This will show the date for a specific day if the MONTH AND DAY match the current date.


== About this fork - from jchunky
...
Inside your Gemfile:
  ...
  gem 'table_builder', '0.0.3', :git => 'git://github.com/sccdigital/table_builder.git' 
